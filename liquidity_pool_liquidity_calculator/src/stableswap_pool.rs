...
pub(crate) fn get_liquidity(
    ...
    let min_price = min_amount * PRICE_PRECISION / estimate_swap(e, fee_fraction, initial_a, initial_a_time, future_a, future_a_time, &reserves_adj, in_idx, out_idx, min_amount);
