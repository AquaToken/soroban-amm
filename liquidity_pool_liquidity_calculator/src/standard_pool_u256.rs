...
pub(crate) fn get_liquidity(
    ...
    for i in 0..reserves.len() {
     ...
     let min_price = min_amount.clone() * &price_precision / estimate_swap(e, &fee_fraction_big, &reserves_adj, in_idx, out_idx, &min_amount);
     ...
     while !last_iteration {
         let mut depth = estimate_swap(e, &fee_fraction_big, &reserves_big, in_idx, out_idx, &in_amt);
